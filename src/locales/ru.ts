const ru = {
  ...
  settings: {
    title: 'Настройки',
    subtitle: 'Управляйте аккаунтом и интеграциями платформ',
  ...
  media: {
    list: {
      ...
      empty: 'Публикации пока не найдены.',
  ...
  comments: {
    ...
    confirmations: {
      deleteComment: {
        ...
        message: 'Комментарий будет навсегда удалён. Это действие нельзя отменить.',
